...
fun<viewHolder,T:RecyclerView.Adapter<viewHolder>> Context.setUpGridRecyclerView(view: RecyclerView, spanCount:Int,viewAdapter:T){
    view.setHasFixedSize(true)
    view.layoutManager = GridLayoutManager(this, spanCount)
    view.adapter = viewAdapter
}
